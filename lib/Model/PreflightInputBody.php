...
/**
 * PreflightInputBody Class Doc Comment
 *
 * @category Class
 * @package  StripyHorse
 * @author   OpenAPI Generator team
 ...
 */
class PreflightInputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PreflightInputBody';
    ...
    public function setHeightMm($height_mm)
    {
        ...
        if (($height_mm < 0)) {
            throw new \InvalidArgumentException('invalid value for $height_mm when calling PreflightInputBody., must be bigger than or equal to 0.');
        }
    ...
    public function setWidthMm($width_mm)
    {
        ...
        if (($width_mm < 0)) {
            throw new \InvalidArgumentException('invalid value for $width_mm when calling PreflightInputBody., must be bigger than or equal to 0.');
        }
