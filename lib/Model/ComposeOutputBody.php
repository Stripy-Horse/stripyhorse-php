...
/**
 * ComposeOutputBody Class Doc Comment
 *
 * @category Class
 * @package  StripyHorse
 * @author   OpenAPI Generator team
 ...
 */
class ComposeOutputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ComposeOutputBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['warnings'] === null && !$this->isNullableSetToNull('warnings')) {
            $invalidProperties[] = "'warnings' is required";
        }
     ...
     * Sets labels
     *
     * @param \StripyHorse\Model\RenderedLabel[]|null $labels Rendered previews when preview=true
     *
     * @return self
     */
