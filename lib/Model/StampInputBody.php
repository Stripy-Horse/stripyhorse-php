...
/**
 * StampInputBody Class Doc Comment
 *
 * @category Class
 * @package  StripyHorse
 * @author   OpenAPI Generator team
 ...
 */
class StampInputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StampInputBody';
     ...
     * Sets image
     *
     * @param string $image PNG/GIF/JPEG, base64-encoded
     *
     * @return self
     */
     ...
     * Sets width_dots
     *
     * @param int|null $width_dots Stamp width in dots; 0 keeps the image's natural size
     *
     * @return self
     */
    ...
    public function setX($x)
    {
        ...
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling StampInputBody., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling StampInputBody., must be bigger than or equal to 0.');
        }
