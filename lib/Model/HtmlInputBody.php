...
/**
 * HtmlInputBody Class Doc Comment
 *
 * @category Class
 * @package  StripyHorse
 * @author   OpenAPI Generator team
 ...
 */
class HtmlInputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HtmlInputBody';
    ...
    {
        return [
            self::COMPRESSION_ACS,
            self::COMPRESSION_Z64,
        ];
    }
    ...
    public function setCompression($compression)
    {
        ...
        $allowedValues = $this->getCompressionAllowableValues();
        if (!in_array($compression, $allowedValues, true)) {
    ...
    public function setHeightMm($height_mm)
    {
        ...
        if (($height_mm < 0)) {
            throw new \InvalidArgumentException('invalid value for $height_mm when calling HtmlInputBody., must be bigger than or equal to 0.');
        }
     ...
     * Sets html
     *
     * @param string $html Label markup: HTML/CSS plus <zpl-barcode> elements
     *
     * @return self
     */
    ...
    public function setThreshold($threshold)
    {
        ...
        if (($threshold > 255)) {
            throw new \InvalidArgumentException('invalid value for $threshold when calling HtmlInputBody., must be smaller than or equal to 255.');
        }
        if (($threshold < 1)) {
            throw new \InvalidArgumentException('invalid value for $threshold when calling HtmlInputBody., must be bigger than or equal to 1.');
        }
    ...
    public function setWidthMm($width_mm)
    {
        ...
        if (($width_mm < 0)) {
            throw new \InvalidArgumentException('invalid value for $width_mm when calling HtmlInputBody., must be bigger than or equal to 0.');
        }
