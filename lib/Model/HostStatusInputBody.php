...
/**
 * HostStatusInputBody Class Doc Comment
 *
 * @category Class
 * @package  StripyHorse
 * @author   OpenAPI Generator team
 ...
 */
class HostStatusInputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HostStatusInputBody';
     ...
     * Sets response
     *
     * @param string $response The three ~HS status lines, as received
     *
     * @return self
     */
